...
| [Provider capability floors](2026-08-15-provider-capability-floors.md) | Provider docs/SLAs (Anthropic, AWS Bedrock, Azure/Microsoft Learn, Google Vertex, OpenAI status API) and live catalogue APIs (Vercel AI Gateway, OpenRouter, Artificial Analysis); URLs inline | Retrieved 2026-08-15 | Provider-risk gateway spec behavior 1; ADR 0001; `providers/capabilities.ts` in the gateway design doc (issues #11, #6) | hoomji | 2026-11-15 |
